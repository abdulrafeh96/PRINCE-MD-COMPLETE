...
${ICON.stop} ${style.toSmallCaps('link bhejne par group se remove kar diya gaya')}
${ICON.lock} ${style.toSmallCaps('group 2 minutes ke liye close kar diya gaya')}`,
                mentions: [sender]
            });
            return;
        }
...
${ICON.stop} ${style.toSmallCaps('links bhejne par remove kar diya gaya')}
${ICON.lock} ${style.toSmallCaps('group 2 minutes ke liye close kar diya gaya')}`,
                    mentions: [sender]
                });
                return;
